    ...
    <section className='max-w-7xl mx-auto'>
        <div>
            ...
            <p className='mt-2 text-[#666e75] text-[14px] max-w[500px]'>
                Créez une collection d'images inspirantes et visuellement magnifiques générées par DALL-E
            </p>
        </div>
        ...
        <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
            ...
            <div className='mt-10'>
                ...
                Une fois que vous avez créé l'image désirée, vous pouvez la partager avec d'autres personnes de la communauté
                </p>
